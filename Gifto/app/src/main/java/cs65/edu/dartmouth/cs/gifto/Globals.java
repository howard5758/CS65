...
public class Globals {
    ...
    static {
        ...
        ITEM_TO_ANIMAL_LIST.put("flower pot 1",new ArrayList<String> (Arrays.asList("cat head","American Shorthair head","Siamese Cat head","Corgi’s head","monkey head")));
        ITEM_TO_ANIMAL_LIST.put("flower pot 2",new ArrayList<String> (Arrays.asList("cat head","American Shorthair head","Siamese Cat head","Corgi’s head","monkey head")));
        ITEM_TO_ANIMAL_LIST.put("flower pot 3",new ArrayList<String> (Arrays.asList("cat head","American Shorthair head","Siamese Cat head","Corgi’s head","monkey head")));
        ...
        ITEM_TO_ANIMAL_LIST.put("brown pot",new ArrayList<String> (Arrays.asList("cat head","American Shorthair head","Siamese Cat head","Corgi’s head","monkey head")));
        ITEM_TO_ANIMAL_LIST.put("green pot",new ArrayList<String> (Arrays.asList("cat head","American Shorthair head","Siamese Cat head","Corgi’s head","monkey head")));
        ...
        ITEM_TO_ANIMAL_LIST.put("banana",new ArrayList<String> (Arrays.asList("monkey", "monkey on tree with banana", "monkey on tree","Corgi", "Corgi side")));
