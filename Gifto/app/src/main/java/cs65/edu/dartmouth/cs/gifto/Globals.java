...
public class Globals {
    ...
    static {
        ...
        ANIMAL_TO_PROB.put("sleeping alligator", .5);
        ANIMAL_TO_PROB.put("alligator", .5);
        ANIMAL_TO_PROB.put("sleeping bat", .4);
        ANIMAL_TO_PROB.put("bat", .4);
        ANIMAL_TO_PROB.put("sleeping cat", .4);
        ANIMAL_TO_PROB.put("cat", .5);
        ANIMAL_TO_PROB.put("kangaroo", .35);
        ANIMAL_TO_PROB.put("sleeping kangaroo", .35);
        ANIMAL_TO_PROB.put("monkey", .4);
        ANIMAL_TO_PROB.put("sleeping monkey", .4);
        ANIMAL_TO_PROB.put("monkey on tree with banana", .1);
        ANIMAL_TO_PROB.put("monkey on tree", .4);
        ANIMAL_TO_PROB.put("owl", .5);
        ANIMAL_TO_PROB.put("sleeping owl", .5);
        ANIMAL_TO_PROB.put("sleeping American Shorthair", .4);
        ANIMAL_TO_PROB.put("American Shorthair", .4);
        ANIMAL_TO_PROB.put("sleeping Siamese Cat", .33);
        ANIMAL_TO_PROB.put("Siamese Cat", .34);
        ANIMAL_TO_PROB.put("sleeping pink squirrel", .4);
        ANIMAL_TO_PROB.put("pink squirrel", .4);
        ANIMAL_TO_PROB.put("sleeping squirrel", .4);
        ANIMAL_TO_PROB.put("squirrel", .4);
        ANIMAL_TO_PROB.put("unicorn with grass", .2);
        ANIMAL_TO_PROB.put("sleeping unicorn", .2);
        ANIMAL_TO_PROB.put("giggling unicorn", .2);
        ANIMAL_TO_PROB.put("unicorn", .2);
        ANIMAL_TO_PROB.put("Corgi back", .5);
        ANIMAL_TO_PROB.put("Corgi", .5);
        ANIMAL_TO_PROB.put("sleeping Corgi", .5);
        ANIMAL_TO_PROB.put("Corgi side", .5);
        ...
        ITEM_TO_ANIMAL_LIST.put("blue mitten",new ArrayList<String> (Arrays.asList("cat", "Siamese Cat", "American Shorthair", "Corgi back", "Corgi", "Corgi side","sleeping Siamese Cat")));
        ITEM_TO_ANIMAL_LIST.put("yellow mitten",new ArrayList<String> (Arrays.asList("cat", "Siamese Cat", "American Shorthair", "Corgi back", "Corgi", "Corgi side","sleeping Siamese Cat")));
